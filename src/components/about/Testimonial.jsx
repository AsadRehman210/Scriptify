...
const testimonialsData = [
  {
    image: alexia,
    quote: '“They met expectations with every aspect of design and development of the product, and we’ve seen an increase in downloads and monthly users.”',
    name: 'Anton Neugebauer',
    title: 'CEO, RealAdvice Agency',
  },
  {
    image: hassan,
    quote: '“Outstanding service! Our collaboration resulted in a highly successful product.”',
    name: 'Emily Johnson',
    title: 'CTO, TechWorld',
  },
  ...
  return (
    <div className="bg-white py-12 px-6 md:px-12 lg:pl-24 lg:pr-0 flex flex-col lg:flex-row items-center">
      ...
      <div className="w-full lg:w-2/5 mb-8 lg:mb-0 flex flex-col justify-center">
        ...
        <NavLink to="/contact" className="bg-transparent border-[1px] border-blue-600 text-blue-600 px-6 py-2 rounded-md hover:bg-blue-600 hover:text-white transition duration-300 mr-auto">
          Contact Us
        </NavLink>
      </div>
              ...
              <SwiperSlide key={index}>
                <div className="flex flex-row items-center relative">
                  <img
                    ...
                    className="shadow-lg mb-4 lg:mb-0 h-[30vh] w-full md:w-[40vw] lg:h-[450px] lg:w-[300px] mx-auto lg:mx-0"
                  />
